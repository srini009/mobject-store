...
static hg_return_t encode_write_action_create(hg_proc_t proc, uint64_t* pos, wr_action_create_t action)
{
...
static hg_return_t decode_write_action_create(hg_proc_t proc, uint64_t* pos, wr_action_create_t* action)
{
...
static hg_return_t encode_write_action_write(hg_proc_t proc, uint64_t* pos, wr_action_write_t action)
{
...
static hg_return_t decode_write_action_write(hg_proc_t proc, uint64_t* pos, wr_action_write_t* action)
{
	hg_return_t ret = HG_SUCCESS;
	args_wr_action_write a;
	ret = hg_proc_memcpy(proc, &a, sizeof(a));
...
static hg_return_t encode_write_action_write_full(hg_proc_t proc, uint64_t* pos, wr_action_write_full_t action)
{
...
static hg_return_t decode_write_action_write_full(hg_proc_t proc, uint64_t* pos, wr_action_write_full_t* action)
{
	hg_return_t ret = HG_SUCCESS;
	args_wr_action_write_full a;
	ret = hg_proc_memcpy(proc, &a, sizeof(a));
...
static hg_return_t encode_write_action_write_same(hg_proc_t proc, uint64_t* pos, wr_action_write_same_t action)
{
...
static hg_return_t decode_write_action_write_same(hg_proc_t proc, uint64_t* pos, wr_action_write_same_t* action)
{
	hg_return_t ret = HG_SUCCESS;
	args_wr_action_write_same a;
	ret = hg_proc_memcpy(proc, &a, sizeof(a));
...
static hg_return_t encode_write_action_append(hg_proc_t proc, uint64_t* pos, wr_action_append_t action)
{
...
static hg_return_t decode_write_action_append(hg_proc_t proc, uint64_t* pos, wr_action_append_t* action)
{
	hg_return_t ret = HG_SUCCESS;
	args_wr_action_append a;
	ret = hg_proc_memcpy(proc, &a, sizeof(a));
...
static hg_return_t encode_write_action_remove(hg_proc_t proc, uint64_t* pos, wr_action_remove_t action)
{
	return HG_SUCCESS;
}

static hg_return_t decode_write_action_remove(hg_proc_t proc, uint64_t* pos, wr_action_remove_t* action)
{
	hg_return_t ret = HG_SUCCESS;
...
static hg_return_t encode_write_action_truncate(hg_proc_t proc, uint64_t* pos, wr_action_truncate_t action)
{
...
static hg_return_t decode_write_action_truncate(hg_proc_t proc, uint64_t* pos, wr_action_truncate_t* action)
{
	hg_return_t ret = HG_SUCCESS;
	args_wr_action_truncate a;
	ret = hg_proc_memcpy(proc, &a, sizeof(a));
...
static hg_return_t encode_write_action_zero(hg_proc_t proc, uint64_t* pos, wr_action_zero_t action)
{
...
static hg_return_t decode_write_action_zero(hg_proc_t proc, uint64_t* pos, wr_action_zero_t* action)
{
	hg_return_t ret = HG_SUCCESS;
	args_wr_action_zero a;
	ret = hg_proc_memcpy(proc, &a, sizeof(a));
...
static hg_return_t encode_write_action_omap_set(hg_proc_t proc, uint64_t* pos, wr_action_omap_set_t action)
{
...
static hg_return_t decode_write_action_omap_set(hg_proc_t proc, uint64_t* pos, wr_action_omap_set_t* action)
{
	hg_return_t ret = HG_SUCCESS;
	args_wr_action_omap_set a;
	ret = hg_proc_memcpy(proc, &a, sizeof(a));
...
static hg_return_t encode_write_action_omap_rm_keys(hg_proc_t proc, uint64_t* pos, wr_action_omap_rm_keys_t action)
{
...
static hg_return_t decode_write_action_omap_rm_keys(hg_proc_t proc, uint64_t* pos, wr_action_omap_rm_keys_t* action)
{
	hg_return_t ret = HG_SUCCESS;
	args_wr_action_omap_rm_keys a;
	ret = hg_proc_memcpy(proc, &a, sizeof(a));
...
hg_return_t hg_proc_mobject_store_write_op_t(hg_proc_t proc, mobject_store_write_op_t write_op)
{
	...
	case HG_ENCODE:
		...
		ret = hg_proc_memcpy(proc, &(write_op->num_actions), sizeof(write_op->num_actions));
		if(ret != HG_SUCCESS) return ret;

		// for each action ...
		DL_FOREACH(write_op->actions,elem) {
			write_op_code_t opcode = elem->type;
			MOBJECT_ASSERT((opcode <= 0 || opcode >= _WRITE_OPCODE_END_ENUM_), "Invalid write_op opcode");
